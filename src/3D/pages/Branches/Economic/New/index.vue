  ...
  <q-page class="main">
    ...
    <div class="row row2">
      ...
      <EconomicHoneycomb
        ...
        subtitle="Общий объём инвестиций, млн ₽"
        :subtitle2="{ number: '+166%', label: 'к АППГ' }"
        dynamic
      />
    </div>
    <div class="row row3">
    ...
    <div class="row row4">
      <EconomicHoneycomb
        ...
        subtitle="Заявки"
        :subtitle2="{ number: '38 503', label: 'Млн ₽' }"
      />
    ...
    <div class="row row5">
      <EconomicHoneycomb
        ...
        number="28%"
        subtitle="Доля МП"
        title="Малое и среднее предпринимательство"
        dynamic
      />
      <EconomicHoneycomb
        class="item"
