<template>
  ...
  >
    <div class="tw-mb-20">
      <NewSubtitle text="Объём инвестиций" class="tw-mb-10 tw-text-center" />

      <div>
        <img src="../images-slides/zayav.svg" alt="" />
      </div>
    </div>

    <div class="tw-text-center">
      <a
        href=" https://cur.bashkortostan.ru/?menukey=4079&type=DASHBOARD"
        target="_blank"
      >
        <AppButton
          icon="diagram"
